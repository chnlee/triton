...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:75", "ttg.threads-per-warp" = 32 : i32} {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %64 = ttg.local_alloc %63 : (tensor<128x32xf32, #blocked2>) -> !ttg.memdesc<128x32xf32, #shared, #smem>
    ...
    %69 = ttg.local_alloc %68 : (tensor<32x64xf32, #blocked1>) -> !ttg.memdesc<32x64xf32, #shared, #smem>
  ...
  ^bb3:  // pred: ^bb1
    ...
    %92 = ttg.convert_layout %54 : tensor<128x64xf32, #blocked> -> tensor<128x64xf32, #blocked1>
